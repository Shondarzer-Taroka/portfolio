      ...
      <header className={`${scrolling ? 'border-b border-gray-900' : ''}  fixed left-0 right-0 top-0 z-20`} id="home">
        <div className="container m-auto px-4 py-6 max-w-4xl bg-black">
          <div className="flex flex-col gap-4 sm:flex-row justify-between items-center">
            <div>
              <h1 className="font-bold text-2xl">Nazmul Hasan</h1>
            </div>
            <div>
              <ul className="flex gap-4">
                ...
                {/* <li>
                  <a href="#code" className="text-gray-400 hover:text-white cursor-pointer">
      ...
      <main className="relative mt-28">
        ...
        <section>
          <div className="container m-auto px-4 pt-12 pb-12 sm:pt-20 flex flex-col sm:flex-row gap-6 text-center sm:text-left">
            <div>
              <h2 className="font-bold text-4xl">Hello, I'm Nazmul Hasan,</h2>
              <div>
              ...
              <div>
                ...
                <div>
                  ...
                  <a href={'https://drive.usercontent.google.com/u/0/uc?id=1CuqQSlvVRelAnsc7rwlrPKh9nrwd_5Rk&export=download'} download="MyExampleDoc" target='_blank'>
                    <button className="px-8 shadow-gray-500 shadow-md py-5 mt-5 bg-gradient-to-t from-blue-500 rounded-full to-cyan-500 hover:from-blue-700 hover:to-cyan-700"> Download resume</button>
                  </a>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-10 mt-11">
              <div className="border border-gray-500 rounded-md p-5 flex-1">
                ...
                <h3 className="text-2xl font-semibold mt-8">
                  Npetoria for pet lovers
                </h3>
                <p className="text-gray-400 text-sm mt-2">
                  Responsive HTML/CSS layout for online pet store. HTML5,
                  CSS3 (SCSS)
                </p>
                <div className="flex mt-12 gap-2">
                  <button className="flex-1 text-sm py-3 bg-gradient-to-t from-blue-500 rounded-full to-cyan-500 hover:from-blue-700 hover:to-cyan-700">
                    <a href="https://assignment-twelve-final.web.app" target="_blank"> View Live</a>
                  </button>
              ...
              <div className="border border-gray-500 rounded-md p-5 flex-1">
                ...
                <h3 className="text-2xl font-semibold mt-8">
                 Tvolu for volunteer management Website
                </h3>
                <p className="text-gray-400 text-sm mt-2">
                  Responsive HTML/CSS layout for online volunteer management HTML5, CSS3 
                </p>
                <div className="flex gap-2 mt-12">
                  <button className="flex-1 text-sm py-3 bg-gradient-to-t from-blue-500 rounded-full to-cyan-500 hover:from-blue-700 hover:to-cyan-700">
                  <a href="https://assignment-eleven-df832.web.app/" target="_blank"> View Live</a>
                  </button>
                  {/* <button className="flex-1 text-sm py-3 border rounded-full hover:border-blue-500 hover:text-blue-500">
                    Checkout github
                  </button> */}
            ...
            <div className="flex flex-col sm:flex-row  gap-10 mt-11">
              <div className="border border-gray-500 rounded-md p-5 flex-1">
                ...
                <div className="flex gap-4 mt-12">
                  <button className="flex-1 text-sm py-3 bg-gradient-to-t from-blue-500 rounded-full to-cyan-500 hover:from-blue-700 hover:to-cyan-700">
                  <a href="https://assignment-ten-server-client.web.app/" target="_blank"> View Live</a>
                  </button>
                  {/* <button className="flex-1 text-sm py-3 border rounded-full hover:border-blue-500 hover:text-blue-500">
                    Checkout github
                  </button> */}
              ...
              <div className="border border-gray-500 rounded-md p-5 flex-1">
                ...
                <h3 className="text-2xl font-semibold mt-8">
                  Website redesign for State management
                </h3>
                <p className="text-gray-400 text-sm mt-2">
                  Responsive HTML/CSS layout for TanaHouse project. HTML5, CSS3
                
                </p>
                <div className="flex gap-2 mt-12">
                  <button className="flex-1 text-sm py-3 bg-gradient-to-t from-blue-500 rounded-full to-cyan-500 hover:from-blue-700 hover:to-cyan-700">
                  <a href="https://assignment-nine-75ab9.web.app/" target="_blank"> View Live</a>
                  </button>
                  {/* <button className="flex-1 text-sm py-3 border rounded-full hover:border-blue-500 hover:text-blue-500">
                    Checkout github
                  </button> */}
        ...
        <section>
          {/* <FuCode></FuCode> */}
          {/* <JavaScriptEditorWithContext></JavaScriptEditorWithContext> */}
        </section>
      </main>
      <footer>
